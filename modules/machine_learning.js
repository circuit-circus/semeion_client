			...
			if(trainingData.length % 30 === 0) {
				...
				try {
					plot({
						...
						filename: 'ml_analysis/output-seed-' + noiseSeed + '-' + trainConfig.learningRate + '.pdf',
						format: 'pdf',
						xlabel: 'Iterations',
						title: 'S: ' + noiseSeed + ',  TO: ' + trainConfig.timeout + ', LR: ' + trainConfig.learningRate
					});
				} catch(err) {
